...
Guidance for Claude Code working in this repo. See `README.md` for the project overview, architecture, and commands — this file only covers what Claude can't infer from the code or README.
